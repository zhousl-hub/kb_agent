-- Nacos 2.3.0 Database Schema
-- Reference: https://github.com/alibaba/nacos/blob/develop/distribution/conf/mysql-schema.sql
...
-- Password is BCrypt encoded: $2a$10$EuWPZHzz32dJN7jexM34MOeYirDdFAZm2kuWj7VEOJhhZkDrxfvUu
-- ----------------------------
